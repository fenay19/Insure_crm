    ...
    return (
        <div style={{ fontFamily: "'Courier New', Courier, monospace", color: '#000', maxWidth: 720, margin: '0 auto', fontSize: '13px' }}>
            ...
            <div style={{ marginBottom: '20px', lineHeight: '1.8' }}>
                ...
                <div>148, 3rd Floor, Above SBI Personal Banking Branch, Thapar Enclave,</div>
                <div>Maharajbagh Road, Ramdaspeth Road, Nagpur-440010</div>
                {inv.billedTo?.gstNo && <div style={{ fontWeight: 'bold', marginTop: '10px' }}>GST No: {inv.billedTo.gstNo}</div>}
            </div>
                ...
                <tbody>
                    <tr>
                        <td style={{ ...cellStyle, verticalAlign: 'top', borderBottom: 'none' }}>
                            <strong>Brokerage</strong> for the month of {inv.monthName || ''}<br/><br/>
                            Add : <strong>CGST @ 9 %</strong> on assessable value of service<br/><br/>
                            Add: <strong>SGST/UTGST @ 9 %</strong> on assessable value of service
                        </td>
                        <td style={{ ...cellStyle, textAlign: 'center', verticalAlign: 'middle', borderBottom: 'none' }}>
                            <strong>{BROKER.hsnCode}</strong>
                        </td>
                        <td style={{ ...cellStyle, textAlign: 'right', verticalAlign: 'top', borderBottom: 'none' }}>
                            {fmtAmount(inv.taxableAmount)}<br/><br/>
                            {fmtAmount(inv.cgst)}<br/><br/>
                            {fmtAmount(inv.sgst)}
                        </td>
                    </tr>
                    <tr>
            ...
            <div style={{ lineHeight: '1.8', marginBottom: '20px' }}>
                <div>Amount in Words (<strong>Rs. {amountInWords}</strong>.)</div>
                <div style={{ fontWeight: 'bold', marginTop: '10px' }}>PAN Number : {BROKER.pan}</div>
                <div style={{ fontWeight: 'bold', marginTop: '10px' }}>GST No: {BROKER.gstn}</div>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '20px' }}>
                <div style={{ lineHeight: '1.6' }}>
                    ...
                    <div>Bank Name & Branch : {BROKER.bank},</div>
                    <div>{BROKER.branch}</div>
